...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    <div class="weapper">
      ...
      <p class="heading">${parseInt(tempFahrenheit)}&deg;<sup>F</sup></p>
    ...
    <p class="label-1">Feels Like: ${parseInt(feelsLikeFahrenheit)}&deg;F</p>
        ...
        <div class="highlight-list">
          ...
          <div class="card card-sm highlight-card">
            ...
            <i class="fa-solid fa-temperature-low"></i>
              ...
              <p class="title-1"> ${celsiusToFahrenheit(feels_like)}&deg;<sup>F</sup></p>
            </div>
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        const tempMinFahrenheit = ((temp_min * 9) / 5) + 32; 
        ...
        li.innerHTML = `
          <div class="icon-wrapper">
            ...
            <p class="title-2">${parseInt(tempMaxFahrenheit)}&deg;</p>
            <p class="label-1">${parseInt(tempMinFahrenheit)}&deg;
